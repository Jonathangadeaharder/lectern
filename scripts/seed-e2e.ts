...
import { resolveDataDir } from '../src/lib/server/config/paths';

const dbPath = process.env.LECTERN_DB_PATH || resolveDataDir().root + '/lectern.db';
const db = new Database(dbPath);

// Drop all tables and recreate via migration
db.exec(`

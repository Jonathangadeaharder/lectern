...
# Diff fixture — three files: a lockfile (hidden by built-in), a normal .ts,
# and a large generated file. Exercises hide/dim/collapse actions.
...
diff --git a/generated/api-types.ts b/generated/api-types.ts
--- a/generated/api-types.ts
+++ b/generated/api-types.ts
@@ -1,4 +1,4 @@
-// @generated by openapi-gen v1
+// @generated by openapi-gen v2
    ...
    "filters": [
        {
            ...
            "label": "E2E marker",
            "scope": "line",
            "match": {"lineRegex": "E2E_FIXTURE_MARKER"},
            "action": "mark",
            "defaultOn": True,
            "description": "Per-PR filter shipped by the fixture.",
        }
    ],
}
...
def main() -> int:
    ...
    atomic_write(ROOT / "diff" / "source.diff", DIFF)
    atomic_write(ROOT / "diff" / "filters.json", json.dumps(FILTERS, indent=2))
    log_line = json.dumps(
